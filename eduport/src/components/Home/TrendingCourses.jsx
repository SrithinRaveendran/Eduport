    ...
    <Col md={6} xl={3} className="mb-4">
      <div className="trending-card h-100">
        ...
        <div className="trending-img-wrap">
          <img src={BASE + course.img} alt={course.title} className="trending-img" />
          <div className="trending-badges">
            <span className="badge-cat">{course.cat}</span>
        ...
        <div className="trending-body d-flex flex-column flex-grow-1">
          ...
          <div className="trending-meta text-muted small mb-2">
            {course.students.toLocaleString()} Students &nbsp;·&nbsp; {course.duration} &nbsp;·&nbsp; {course.lectures} lectures
          </div>
          ...
          <div className="trending-footer d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center gap-2">
              <img src={AVA + course.instructorImg} alt={course.instructor} className="instr-avatar" />
